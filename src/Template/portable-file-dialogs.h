...
// path implementation
    inline std::string path::home() {
        ...
        if (OpenProcessToken(GetCurrentProcess(), TOKEN_QUERY, &token)) {
            ...
            dll::proc < BOOL
                    WINAPI(HANDLE, LPSTR, LPDWORD) > get_user_profile_directory(userenv, "GetUserProfileDirectoryA");
...
// ole32_dll implementation
    ...
    inline internal::platform::ole32_dll::ole32_dll()
        ...
        auto coinit = proc < HRESULT
                WINAPI(LPVOID, DWORD) > (*this, "CoInitializeEx");
        ...
        m_async->start_func([this, in_type, title, default_path, filter_list,
            ...
            if (in_type == type::folder) {
                ...
                if (list) {
                    ...
                    dll::proc < void
                            WINAPI(LPVOID) > (ole32, "CoTaskMemFree")(list);
            ...
            if (in_type == type::save) {
                ...
                dll::proc < BOOL
                        WINAPI(LPOPENFILENAMEW) > get_save_file_name(comdlg32, "GetSaveFileNameW");
                ...
                dll::proc < BOOL
                        WINAPI(LPOPENFILENAMEW) > get_open_file_name(comdlg32, "GetOpenFileNameW");
        ...
        if (SUCCEEDED(hr)) {
            ...
            if (SUCCEEDED(hr)) {
                ...
                if (SUCCEEDED(item->GetDisplayName(SIGDN_FILESYSPATH, &wname))) {
                    ...
                    dll::proc < void
                            WINAPI(LPVOID) > (ole32_dll(), "CoTaskMemFree")(wname);
                } else {
